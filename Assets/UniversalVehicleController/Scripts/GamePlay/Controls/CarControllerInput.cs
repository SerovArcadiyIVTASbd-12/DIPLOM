...
namespace PG
{
    ...
    public class CarControllerInput :InitializePlayer, ICarControl
    {
        ...
        public override bool Initialize (VehicleController car)
        {
            ...
            action = actions.Find(a => a.name == "InfoPanel");
            AddAction(action, OnInfoPanel, InputActionPhase.Started);

            action = actions.Find(a => a.name == "SavetyPanel");
            AddAction(action, OnSavetyPanel, InputActionPhase.Started);
        ...
        void OnInfoPanel (InputAction.CallbackContext context)
        {
            DamageHuman.activateMessagePanel();
        }


        void OnSavetyPanel(InputAction.CallbackContext context)
        {
            SkeletDamage.activateSavetyPanel();
        }
